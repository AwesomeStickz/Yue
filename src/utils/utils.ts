...
export const utils = {
    ...
    async getSlotsOfLevel(level: number) {
        const otherSlots = [1, 2, 5, 8, 12, 18, 30, 45, 60, 75, 100, 125, 150, 200, 250, 300, 350, 450, 600, 750, 1000, 1250, 1500];
        const workerSlots = [2, 5, 8, 12, 18, 30, 45, 60, 75, 100, 125, 150, 200, 250, 300, 350, 450, 600, 750, 1000, 1250, 1500];
