...
type PropertyNames = 'balance' | 'beg' | 'essence' | 'daily' | 'don' | 'inventory' | 'level' | 'luck' | 'navigate' | 'networth' | 'owners' | 'pat' | 'prefix' | 'rentcollect' | 'rep' | 'shopcollect' | 'streak' | 'tipcollect' | 'weekly' | 'winnings';
