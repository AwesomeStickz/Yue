...
type PropertyNames = 'balance' | 'beg' | 'essence' | 'daily' | 'don' | 'inventory' | 'level' | 'luck' | 'navigate' | 'networth' | 'owners' | 'prefix' | 'rentcollect' | 'rep' | 'shopcollect' | 'streak' | 'tipcollect' | 'weekly' | 'winnings';
